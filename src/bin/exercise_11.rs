...
// Exercise 11: Lifetimes
// By only changing the lifetimes in the signatures of the functions, 
// make the code compile and the tests pass.
// To run the tests at the bottom of the file, run "cargo test"
// When you're done with one part, uncomment the next part of the code by removing /*
// Similarly also uncomment the matching part of the tests.
...
fn extract_from_wrapper(wrapper: &Wrapper) -> &str {
    wrapper.storage
}

/*
// Part 2
fn get_value(map: &HashMap<&str, &str>, key: &str) -> Option<&str> {
    match map.get(key) {
...
/*
// Part 3
fn insert_value(map: &mut HashMap<&str, &str>, key: &str, value: &str) {
...
fn divide_big_object(object: &BigObject<'_, '_, '_, '_, '_>) -> Option<(&&str, &&str, &i32, &str, &u32, &str)> {
...
mod tests {
    ...
    fn test_extract_from_wrapper() {
        ...
        let wrapper = Wrapper { storage: &string };
