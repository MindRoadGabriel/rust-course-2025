...
// When you're done with one part, uncomment the next part of the code by removing /* below
...
fn divide_big_object<'object, 'countries, 'cities, 'map, 'inner, 'inner_string>(object: &BigObject<'_, '_, '_, '_, '_>) -> Option<(&&str, &&str, &i32, &str, &u32, &str)> {
